...
class IWR6843AOPEraser:
    ...
    def _simple_connect(self):
        ...
        4. Validate connection is ready for erasing
        ...
        # STEP 2: Determine device version for IWR6843AOP (needed for proper protocol)
...
def main():
    ...
    - Operation: Always full erase
    """
    global comm_logger
    
    print("IWR6843AOP Erase Tool - Standalone")
    print("Using hardcoded settings: COM9, SFLASH erase")
    print("=" * 48)
